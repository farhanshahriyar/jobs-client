...
const Contact = () => {
  const contactHandler = (e) => {
    ...
    // console.log("Contact e click porse mama");
        ...
        fetch('https://server-ewpifyj7q-farhanshahriyar.vercel.app/contacts',{
          method: 'POST',
          headers: {
    ...
    <div className="mt-12 grid items-center lg:grid-cols-2 gap-6 lg:gap-16">
      ...
      <div className="divide-y divide-gray-200 dark:divide-gray-800">
        ...
        <div className="flex gap-x-7 py-6">
          <svg className="flex-shrink-0 w-6 h-6 mt-1.5 text-gray-800 dark:text-gray-200" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" ><circle cx="12" cy="12" r="10"/><path d="M9.09 9a3 3 0 0 1 5.83 1c0 2-3 3-3 3"/><path d="M12 17h.01"/></svg>
          <div className="grow">
            <h3 className="font-semibold text-gray-800 dark:text-gray-200">Knowledgebase About Jobs</h3>
            <p className="mt-1 text-sm text-gray-500">We're here to help with any questions or contact</p>
        ...
        {/* <div className=" flex gap-x-7 py-6">
          <svg className="flex-shrink-0 w-6 h-6 mt-1.5 text-gray-800 dark:text-gray-200" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="m7 11 2-2-2-2"/><path d="M11 13h4"/><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/></svg>
          <div className="grow">
